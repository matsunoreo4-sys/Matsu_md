...
⏱️ Uptime: ${formatUptime(process.uptime())}`;
            ...
            case 'gitclone': {
                try {
                    ...
                    await nato.sendMessage(from, { document: { url: zipUrl }, fileName: filename, mimetype: 'application/zip' }, { quoted: m });
            ...
            case 'igdl': {
                ...
                try {
                    ...
                    await nato.sendMessage(from, { text: stylishReply("⏳ Media found! Downloading now...") }, { quoted: m });
...
case 'nwaifu': {
    ...
    await nato.sendMessage(m.chat, {
        image: { url: imageUrl },
        caption: "```Your Random Waifu by matsu md```"
      }, { quoted: m }); // Add quoted option for context
      }
      break;
      case 'waifu' :
